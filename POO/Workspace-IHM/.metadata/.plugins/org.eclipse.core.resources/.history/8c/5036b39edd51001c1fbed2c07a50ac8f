package fr.ensma.a3.ia.mvc.action;

import fr.ensma.a3.ia.mvc.action.automate.EtatAllDisable;
import fr.ensma.a3.ia.mvc.action.automate.EtatAllEnable;
import fr.ensma.a3.ia.mvc.action.automate.EtatButtonDisable;
import fr.ensma.a3.ia.mvc.action.automate.IEtatAction;
import fr.ensma.a3.ia.mvc.action.automate.TransitionActionException;
